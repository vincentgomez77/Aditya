...
module.exports = {
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'vincentʟ¹¹;ʀᴀɢᷨᴀͦɴͭᴏʀᴋ;https://https://i.imgur.com/paTLqLv.jpeg' : process.env.AUDIO_DATA,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLK: process.env.OWNER_NAME === undefined ? 'vincent¹¹' : process.env.OWNER_NAME,
    ...
    SOURAVKL11: process.env.STICKER_DATA === undefined ? 'vincent¹¹|ʀᴀɢᷨᴀͦɴͭᴏʀᴋ' : process.env.STICKER_DATA,
    ANTI_FAKE: process.env.AUTO_FAKE === undefined ? 'vincent' : process.env.AUTO_FAKE,
